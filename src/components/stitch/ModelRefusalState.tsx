  ...
  return (
    <section className="flex flex-col bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center min-h-[400px]">
        ...
        <button
          onClick={onClear}
          className="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-5 py-2 rounded-lg font-medium text-sm transition-colors"
        >
